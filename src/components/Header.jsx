...
const Header = () => {
  ...
  const navItems = [
    { href: "/#features", label: t("header.features", "features") },
    { href: "/#income-streams", label: t("header.income", "Income") },
    { href: "/#withdrawals", label: t("header.withdrawals", "Withdrawals") },
    { href: "/#how-it-works", label: t("header.how", "How it works") },
  ];
