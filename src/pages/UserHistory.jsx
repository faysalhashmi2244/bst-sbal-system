...
const UserHistory = () => {
    ...
    try {
      ...
      toast.success(
        t("userHistory.eventsFound", {
          ...
          defaultValue: `Found ${response.events.length} events for this user`,
        }),
      );
    } catch (error) {
  ...
  const getEventDisplayName = (eventType) => {
    ...
    const eventDisplayMap = {
      REFERRALREGISTEREDANDREWARDDISTRIBUTED: `${level}-Level Referral System`,
